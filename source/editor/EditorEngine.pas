...
type
  ...
  published
    ...
    property Console: TThreeStates read FInfo.Console write FInfo.Console default stateNone;
...
begin
  ...
  begin
    CreateGUID(aGUID);
    TCustomSynEdit(Sender).InsertTextAtCaret(UUIDToString(aGUID));
    Handled := True;
  end;
end;
